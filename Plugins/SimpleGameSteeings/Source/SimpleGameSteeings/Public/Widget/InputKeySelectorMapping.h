...
public:
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam( FOnIsSelectingKeyMapingChanged, UInputKeySelectorMapping *,InputKeySelector);
...
public:
	...
	UPROPERTY( BlueprintAssignable, Category = "Widget Event" )
	FOnIsSelectingKeyMapingChanged OnIsSelectingKeyChanged;
