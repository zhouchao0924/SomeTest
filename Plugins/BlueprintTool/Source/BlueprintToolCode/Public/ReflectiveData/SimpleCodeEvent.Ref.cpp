...
void USimpleCodeEvent::BlueprintGameBegins(UStaticMeshComponent* Target)
{
	TSharedPtr<FFunctionParameter> FunctionParameter = nullptr;
	AddParaAddr(Target, FunctionParameter);
	ExecutionScript(FindScriptFuntion(Name_BlueprintGameBegins),&FunctionParameter);
} 
