		...
		[
			...
			[
				...
				[
					...
					//.OnClicked_Lambda([]()
					//{
					//	FModuleManager::LoadModuleChecked<FCustomizeUE4EditorModule>("CustomizeUE4Editor").ShowDialogForPackageTheme();
					//	return FReply::Handled();
					//})
				]
			]
			...
			[
				...
				//.OnClicked_Lambda([]()
				//{
				//	FModuleManager::LoadModuleChecked<FCustomizeUE4EditorModule>("CustomizeUE4Editor").ImportBuiltInTheme();
				//	return FReply::Handled();
				//})
			]
			+ SVerticalBox::Slot()
			[
				...
				[
					...
					//.OnClicked_Lambda([]()
					//{
					//	FModuleManager::LoadModuleChecked<FCustomizeUE4EditorModule>("CustomizeUE4Editor").ResetEditorStyle();
				...
				[
					...
					//.OnClicked_Lambda([]()
					//{
					//	FModuleManager::LoadModuleChecked<FCustomizeUE4EditorModule>("CustomizeUE4Editor").ResetCoreStyle();
				...
				[
					...
					//.OnClicked_Lambda([]()
					//{
					//	FModuleManager::LoadModuleChecked<FCustomizeUE4EditorModule>("CustomizeUE4Editor").ResetTextStyle();
